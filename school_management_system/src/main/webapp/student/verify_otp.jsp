			...
			<div class="col-md-4 offset-md-4">
				<div class="card paint-card">
					...
					%>
						...
						<form action="../verify_student_otp" >
						...
						<% Student std=(Student)session.getAttribute("studentEmail"); %>
						<p class ="fs-4">
							<a href="../student_otp?email=<%= std.getEmail() %>" class="text-decoration-none text-success">Resend OTP</a>
						</p>
					</div>
				</div>
			</div>
